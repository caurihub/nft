...
import { Builders as NFTBuilders, Interfaces as NFTInterfaces } from "@caurihub/nft-base-crypto";
...
export class NFTExchangeTransactionFactory extends TransactionFactory {
    ...
    public static override initialize(app?: Contracts.Kernel.Application): NFTExchangeTransactionFactory {
