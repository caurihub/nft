...
import { AbstractNFTTransaction } from "@caurihub/core-nft-crypto";
...
export class NFTTransferTransaction extends AbstractNFTTransaction {
	...
	public static override type: number = NFTBaseTransactionTypes.NFTTransfer;
	public static override key = "NFTTransfer";
	public static override version = NFTBaseTransactionVersion;

	protected static override defaultStaticFee = Utils.BigNumber.make(NFTBaseStaticFees.NFTTransfer);
