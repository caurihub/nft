...
export class NFTCreateTransaction extends AbstractNFTTransaction {
	...
	public static override type = NFTBaseTransactionTypes.NFTCreate;
	public static override key = "NFTCreate";
	public static override version = NFTBaseTransactionVersion;

	protected static override defaultStaticFee = Utils.BigNumber.make(NFTBaseStaticFees.NFTCreate);
